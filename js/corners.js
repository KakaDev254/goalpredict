...
function renderPastCorners() {
  ...
  if (!datePredictions && cornersPredictions.length > 0) {
...
// REMOVED: addCornersDateSelector function - using global date selector instead

// Function to calculate total odds for corners
